...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_Elec_Engg_10_03_01_process_check_sum_call( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_Elec_Engg_10_03_01_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return
  1;
  return 0;
}
...
{
  extern unsigned int sf_Elec_Engg_10_03_01_autoinheritance_info( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_Elec_Engg_10_03_01_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
...
extern unsigned int sf_Elec_Engg_10_03_01_method_dispatcher(SimStruct *S, const
 char *chartName, int_T method, void *data);
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
 char *chartName, int_T method, void *data)
{
  if(sf_Elec_Engg_10_03_01_method_dispatcher(simstructPtr,chartName,method,data))
  return 1;
  return 0;
}
extern void Elec_Engg_10_03_01_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    Elec_Engg_10_03_01_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void Elec_Engg_10_03_01_initializer(void);
extern void Elec_Engg_10_03_01_debug_initialize(void);
void sf_machine_global_initializer(bool simModeIsRTWGen)
{
  if(sfMachineGlobalInitializerCallable) {
    sfMachineGlobalInitializerCallable = 0;
    sfMachineGlobalTerminatorCallable =1;
    if(!simModeIsRTWGen) {
      Elec_Engg_10_03_01_debug_initialize();
    }
    Elec_Engg_10_03_01_initializer();
  }
  return;
}
